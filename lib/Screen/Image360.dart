...
class Image306 extends StatefulWidget {
  const Image306({super.key});

  @override
  State<Image306> createState() => _Image306State();
}

class _Image306State extends State<Image306> with SingleTickerProviderStateMixin {
  late Scene _scene;
  Object? _earth;
  late Object _stars;
  ...
  void _onSceneCreated(Scene scene) {
    ...
    generateSphereObject(_earth!, 'surface', 0.485, true, 'assets/4096_earth.jpg');
    generateSphereObject(_earth!, 'clouds', 0.5, true, 'assets/4096_clouds.png');
